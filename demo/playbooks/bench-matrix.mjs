...
async function main() {
  ...
  // The corpus is generated by demo/data/extras/generate_demo_corpus.py, not captured
  // traffic. Calling it "real" here published a false claim on the public benchmarks
  // page, because this file writes SCORECARD.md and the website is built from it.
  md += `Corpus: synthetic LLM-telemetry with realistic field shapes and seeded distributions, generated by \`demo/data/extras/generate_demo_corpus.py\` (${humanDocs(READ_DOCS)} docs for reads, cycled from the 4,008 distinct events in the committed file). `;
