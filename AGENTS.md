...
- **The hard gate:** the ES-YAML conformance suite must stay at 1365 passed / 0 failed / 3 skipped before any engine change lands (see "Running the conformance tests" in the README). When cases are added deliberately, update this baseline to the latest verified full-suite result rather than preserving a stale count.
